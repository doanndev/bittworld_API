...
export class SharedWebSocketService implements OnModuleInit, OnModuleDestroy {
    ...
    onModuleInit() {
        // SolanaTracker removed - WebSocket connection disabled
        // this.connect();
        this.logger.warn('SharedWebSocketService SolanaTracker connection is disabled - SolanaTracker has been removed');
    }
