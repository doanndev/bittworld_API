...
export class OnChainService implements OnModuleInit, OnModuleDestroy {
    ...
    async getChartData(
        ...
        try {
            ...
            // SolanaTracker removed - using virtual candle only
            ...
            // SolanaTracker removed - always use virtual candle
            this.logger.log(`SolanaTracker removed, generating virtual candle for ${tokenAddress}`);
