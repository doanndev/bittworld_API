...
@Module({
  imports: [
    ...
    // MongooseModule removed - MongoDB connection disabled
    ...
    // MasterTradingModule, // Removed - trading module disabled
    // TradeModule, // Removed - trading module disabled
    PriceFeedModule,
    PumpFunModule,
    SolanaTokensModule,
    ...
    // ChatsModule, // Removed - chat module disabled
    ReferralModule,
